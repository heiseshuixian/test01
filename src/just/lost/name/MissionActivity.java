...
public class MissionActivity extends Activity {
	...
	Handler handle = new Handler(){
		...
		public void handleMessage(Message msg) {
			...
			case 0:
                ...
                intent.setClass(MissionActivity.this, Test01Activity.class);
			...
			case 2:
				tv.setText("找不到服务器地址");	
				pb.setVisibility(ProgressBar.GONE);
				Toast.makeText(getApplicationContext(), "找不到服务器地址。",
					     Toast.LENGTH_SHORT).show();
				 intent = new Intent();
               intent.setClass(MissionActivity.this, Test01Activity.class);
               startActivity(intent);
	...
	public class Upload extends Thread {
		...
		public void run() {
			// TODO Auto-generated method stub
			super.run();	
			ConnectionDetector cd = new ConnectionDetector(MissionActivity.this);
			if(cd.isConnectingToInternet()){
				if(cd.checkURL("http://192.168.1.102:8080/testsever/Videoservlet")){
					uploadFile(filpath);
	...
	public void uploadFile(String imageFilePath) {
		String actionUrl = "http://192.168.1.102:8080/testsever/Videoservlet";
